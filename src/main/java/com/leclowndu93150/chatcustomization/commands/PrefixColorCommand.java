...
public class PrefixColorCommand extends AbstractPlayerCommand {
    ...
    public PrefixColorCommand(@Nonnull ChatManager chatManager) {
    ...
    protected void execute(@Nonnull CommandContext context, @Nonnull Store<EntityStore> store,
        ...
        if (color.isEmpty() || color.equalsIgnoreCase("clear")) {
            chatManager.setColor(playerRef.getUuid(), "prefix", null);
            context.sendMessage(Message.raw("Your prefix color has been reset to default.").color("GREEN"));
            return;
        }
