...
public class PronounsColorCommand extends AbstractPlayerCommand {
    ...
    private final RequiredArg<String> colorArg = this.withRequiredArg("color", "Color name or hex code (e.g. GRAY, #AAAAAA)", ArgTypes.STRING);

    public PronounsColorCommand(@Nonnull ChatManager chatManager, @Nonnull Supplier<ChatCustomizationConfig> configSupplier) {
